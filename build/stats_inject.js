(() => {
  ...
  var require_chart = __commonJS({
    "node_modules/chart.js/dist/chart.js"(exports, module) {
      (function(global, factory) {
        ...
        var Ticks = { formatters: formatters3 };
        defaults.set("scale", {
          display: true,
          offset: false,
          reverse: false,
        ...
        class TimeScale extends Scale {
          ...
          init(scaleOpts, opts) {
            ...
            const adapter = this._adapter = new _adapters2._date(scaleOpts.adapters.date);
  ...
  function parseTimezonePattern(pattern, string) {
    ...
    return {
      value: sign * (hours * MILLISECONDS_IN_HOUR2 + minutes * MILLISECONDS_IN_MINUTE2 + seconds * MILLISECONDS_IN_SECOND),
      rest: string.slice(matchResult[0].length)
    };
  }
  ...
  import_chart._adapters._date.override({
    _id: "date-fns",
    formats: function() {
      return FORMATS;
    },
  ...
  async function startup() {
    ...
    rn = new Date();
    createDateChart("average_speed_one_month", configureDividedDataset(game_json_data, "process_path"), "x", subMonths(rn, 1), void 0, "line", "Average Reading Speed", "date", "Time", "read_speed", "Reading Speed (Chars per Hour)");
    createDateChart("chars_read_one_month", configureCombinedDataset(game_json_data, "date"), "x", subMonths(rn, 1), void 0, "bar", "Chars Read", "date", "Time", "chars_read", "Chars Read");
    createDateChart("hours_read_one_month", configureCombinedDataset(game_json_data, "date"), "x", subMonths(rn, 1), void 0, "bar", "Read Time", "date", "Time", "time_read", "Read Time (Hours)");
    createDateChart("average_speed_six_months", configureDividedDataset(game_json_data, "process_path"), "x", subMonths(rn, 6), void 0, "line", "Average Reading Speed", "date", "Time", "read_speed", "Reading Speed (Chars per Hour)");
    createDateChart("chars_read_six_months", configureCombinedDataset(game_json_data, "date"), "x", subMonths(rn, 6), void 0, "bar", "Chars Read", "date", "Time", "chars_read", "Chars Read");
    createDateChart("hours_read_six_months", configureCombinedDataset(game_json_data, "date"), "x", subMonths(rn, 6), void 0, "bar", "Read Time", "date", "Time", "time_read", "Read Time (Hours)");
    createDateChart("average_speed_twelve_months", configureDividedDataset(game_json_data, "process_path"), "x", subMonths(rn, 12), void 0, "line", "Average Reading Speed", "date", "Time", "read_speed", "Reading Speed (Chars per Hour)");
    createDateChart("chars_read_twelve_months", configureCombinedDataset(game_json_data, "date"), "x", subMonths(rn, 12), void 0, "bar", "Chars Read", "date", "Time", "chars_read", "Chars Read");
    createDateChart("hours_read_twelve_months", configureCombinedDataset(game_json_data, "date"), "x", subMonths(rn, 12), void 0, "bar", "Read Time", "date", "Time", "time_read", "Read Time (Hours)");
    createDateChart("average_speed_all_time", configureDividedDataset(game_json_data, "process_path"), "x", void 0, void 0, "line", "Average Reading Speed", "date", "Time", "read_speed", "Reading Speed (Chars per Hour)");
    createDateChart("chars_read_all_time", configureCombinedDataset(game_json_data, "date"), "x", void 0, void 0, "bar", "Chars Read", "date", "Time", "chars_read", "Chars Read");
    createDateChart("hours_read_all_time", configureCombinedDataset(game_json_data, "date"), "x", void 0, void 0, "bar", "Read Time", "date", "Time", "time_read", "Read Time (Hours)");
    createChart("chars_read_per_game", configureCombinedDataset(game_json_data, "process_path"), "x", void 0, void 0, "bar", "Chars Read", "name", "Game", "chars_read", "Chars Read");
    createChart("hours_read_per_game", configureCombinedDataset(game_json_data, "process_path"), "x", void 0, void 0, "bar", "Read Time", "name", "Game", "time_read", "Read Time (Hours)");
    createChart("average_speed_per_game", configureCombinedDataset(game_json_data, "process_path"), "y", void 0, void 0, "bar", "Average Speed", "read_speed", "Reading Pace (Chars per Hour)", "name", "Game");
  }
  startup();
})();
/*!
