...
export class VNStorage extends MediaStorage {
    ...
    constructor(type_storage: TypeStorage, instance_storage?: InstanceStorage, live_stat_update=false) {
    ...
    static async build(live_stat_update=false) {
        ...
        return new VNStorage(media_storage.type_storage, media_storage.instance_storage, live_stat_update)
    }
